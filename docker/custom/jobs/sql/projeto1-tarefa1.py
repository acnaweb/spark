...
# resultado.write.csv('data/resultado_tarefa1', header = True, mode="overwrite")

resultado.write.format("csv").mode("overwrite").options(header = True, sep=";").save('data/resultado_tarefa2')
